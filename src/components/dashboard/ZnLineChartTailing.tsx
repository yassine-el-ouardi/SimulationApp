...
const ZnLineChartTailing: React.FC = () => {
    ...
    datasets: [
      {
        ...
        label: '%',
        data: dataPoints,
        borderColor: 'rgb(76, 0, 153)',
        backgroundColor: 'rgba(76, 0, 153, 0.5)',
      },
    ],
  };
...
export default ZnLineChartTailing;