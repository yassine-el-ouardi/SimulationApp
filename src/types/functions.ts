...
import { IChart, INode, IPort, ISelection } from './chart'
...
export type IStateCallback<T extends (...args: any) => any> = (...params: Parameters<T>) => (chart: IChart, selection: ISelection) => { chart: IChart, selection: ISelection }
